...
//    @Published var isScraped: Bool = false
...
//            if let error = error {
//                print("GET Network Error: \(error.localizedDescription)")
//                completion(nil)
//                return
//            }
//            guard
