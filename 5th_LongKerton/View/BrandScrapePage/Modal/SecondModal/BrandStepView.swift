            ...
            HStack(spacing: 16) { // 이미지 + 텍스트 수평 배치
                ...
                VStack(alignment: .leading, spacing: 8) { // 텍스트들 수직 정렬
                    ...
                    Text(levelCount) // 디깅 횟수 텍스트
                        ...
                        .frame(width: 63, height: 9) // 텍스트 박스 크기 고정
                        .foregroundColor(Color.NickWhite) // 텍스트 색상
                        .background(
                            RoundedRectangle(cornerRadius: 5) // 배경 둥근 사각형
